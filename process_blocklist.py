...
Usage:
  python process_blocklist.py [file ...]
  python process_blocklist.py blocklist.txt --dry-run
  python process_blocklist.py *.txt --fix       # auto-fix safe issues
  python process_blocklist.py --strict          # warnings become errors
  python process_blocklist.py --sort            # sort rules alphabetically
  python process_blocklist.py --stats           # print detailed statistics
"""
...
def build_step_summary(
    ...
    lines.append(f"\n---")
    lines.append(f"*Generated by `process_blocklist.py` at {now}*")
